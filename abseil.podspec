...
Pod::Spec.new do |s|
  ...
  s.subspec 'base' do |s1|
    ...
    s1.subspec 'bits' do |s2|
      s2.source_files = 'absl/base/internal/bits.h'
      s2.dependency 'abseil/base/config'
      s2.dependency 'abseil/base/core_headers'
    end
    ...
    s1.subspec 'exponential_biased' do |s2|
      s2.source_files = 'absl/base/internal/exponential_biased.cc',
    ...
    s1.subspec 'periodic_sampler' do |s2|
      s2.source_files = 'absl/base/internal/periodic_sampler.cc',
                        'absl/base/internal/periodic_sampler.h'
      s2.dependency 'abseil/base/core_headers'
      s2.dependency 'abseil/base/exponential_biased'
    end
  ...
  s.subspec 'container' do |s1|
    ...
    s1.subspec 'have_sse' do |s2|
      s2.source_files = 'absl/container/internal/have_sse.h'
    end
    ...
    s1.subspec 'node_hash_policy' do |s2|
      s2.source_files = 'absl/container/internal/node_hash_policy.h'
      s2.dependency 'abseil/base/config'
    end
  ...
  s.subspec 'flags' do |s1|
    ...
    s1.subspec 'handle' do |s2|
      s2.source_files = 'absl/flags/internal/commandlineflag.h'
      s2.dependency 'abseil/base/config'
      s2.dependency 'abseil/base/core_headers'
      s2.dependency 'abseil/flags/config'
      s2.dependency 'abseil/flags/marshalling'
  ...
  s.subspec 'random' do |s1|
    s1.subspec 'bit_gen_ref' do |s2|
      ...
      s2.dependency 'abseil/random/internal/mocking_bit_gen_base'
    end
    ...
    s1.subspec 'internal' do |s2|
      ...
      s2.subspec 'distributions' do |s3|
        s3.source_files = 'absl/random/internal/distributions.h'
      ...
      s2.subspec 'mocking_bit_gen_base' do |s3|
        s3.source_files = 'absl/random/internal/mocking_bit_gen_base.h'
        s3.dependency 'abseil/random/random'
        s3.dependency 'abseil/strings/strings'
      end
  ...
  s.subspec 'strings' do |s1|
    s1.subspec 'internal' do |s2|
      s2.source_files = 'absl/strings/internal/char_map.h',
  ...
  s.subspec 'synchronization' do |s1|
    ...
    s1.subspec 'kernel_timeout_internal' do |s2|
      s2.source_files = 'absl/synchronization/internal/kernel_timeout.h'
      s2.dependency 'abseil/base/core_headers'
      s2.dependency 'abseil/base/raw_logging_internal'
